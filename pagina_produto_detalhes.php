    ...
    <div class="row">
        <div class="col">
            ...
            <ul class="nav nav-tabs" style="margin-top: 30px;">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="pagina_produto_descricao.html">Descrição</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="#">Detalhes</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="list-group list-group-flush" style="margin-top: 30px;"></ul>
              <li class="list-group-item">Tecido:     Não estirável</li>
              <li class="list-group-item">Decote:	  Gola Redonda</li>
              <li class="list-group-item">Comprimento:	     Regular</li>
              <li class="list-group-item">Estação:	   Outono / Inverno</li>
            </ul>
