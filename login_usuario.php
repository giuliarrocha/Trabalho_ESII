        ...
        <div style="margin-left:70px; margin-right:70px; margin-top: 30px;" class="d-flex flex-row justify-content-around">
            <div class="p-5 w-100">
                <div class="container">
                    ...
                    <p style="margin-top: 15px; padding-bottom: 40px;" class="cinza centro">Já é cadastrado? Faça login na sua conta!</p>

                    <form action="backend/entrar_cliente.php" method="post">
            ...
            <div class="p-5 w-100"><div class="container letraTitulo">Criar conta</div>
                ...
                <form action="backend/cadastrar_cliente.php" method="post">
                    <div class="espaco15 cadastrar row">
                      <label for="staticEmail" class="col-sm-2 col-form-label d-none d-lg-block">Nome:</label>
                      <div class="col-sm-10">
                        <input style="margin-left: 5px;" type="text" class="form-control" id="nome" name="nome" placeholder="Nome" required>
                      </div>
                    </div>
                    <div class="espaco30 cadastrar row">
                      <label for="staticEmail" class="col-sm-2 col-form-label d-none d-lg-block">CPF:</label>
                      <div class="col-sm-10">
                        <input style="margin-left: 5px;" type="text" class="form-control" id="cpf" name="cpf" placeholder="CPF" required>
                      </div>
                    </div>
                    <div class="espaco30 cadastrar row">
                      <label for="staticEmail" class="col-sm-2 col-form-label d-none d-lg-block">E-mail:</label>
