                ...
                <div class="card-header">
                    ...
                    <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                        <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                            <li class="nav-item"> <a data-toggle="pill" href="pagamento_cartao.html" class="nav-link active "> <i class="fas fa-credit-card mr-2"></i> Cartão </a> </li>
                            <li class="nav-item"> <a data-toggle="pill" href="pagamento_boleto.html" class="nav-link "> <i class="fab fa-paypal mr-2"></i> Boleto Bancário </a> </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="cartao_credito" class="tab-pane fade show active pt-3">
                            <form action="backend/efetua_compra.php" method="post">
                                <div class="form-group"> <label for="username">
                                        <h6>Tipo de cartão:</h6>
                                    </label> <select name="tipoCartao" class="form-select form-select" aria-label=".form-select">
                                ...
                                <div class="form-group"> <label for="cardNumber">
                                    ...
                                    <div class="input-group"> <input type="text" name="numeroCartao" placeholder="Número do cartão" class="form-control " required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group"> <label><span class="hidden-xs">
                                            ...
                                            <div class="input-group"> <input type="number" placeholder="DD" name="dia" class="form-control" required><input type="number" placeholder="MM" name="mes" class="form-control" required> <input type="number" placeholder="YYYY" name="ano" class="form-control" required> </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group mb-4"> <label data-toggle="tooltip" title="Three digit CV code on the back of your card">
                                                <h6>CVV <i class="fa fa-question-circle d-inline"></i></h6>
                                            </label> <input type="text" name="cvv" placeholder="***" required class="form-control"> </div>
                                    </div>
                                </div>
                                <div class="card-footer"> <button type="submit" name="submit" class="subscribe w-100 btn btn-primary btn-block shadow-sm"> Prosseguir com a compra </button>
                            </form>
                        </div>
                    </div> 
                    ...
                    <div id="boleto" class="tab-pane fade pt-3">
                        <h6 class="pb-2">Selecione o meio de pagamento:</h6>
                        <div class="form-group "> <label class="radio-inline"> <input type="radio" name="optradio" checked> Domestic </label> <label class="radio-inline"> <input type="radio" name="optradio" class="ml-5">International</label></div>
                        <p> <button type="button" class="btn btn-primary "><i class="fab fa-paypal mr-2"></i> Log into my Paypal</button> </p>
                        <p class="text-muted"> Nota: After clicking on the button, you will be directed to a secure gateway for payment. After completing the payment process, you will be redirected back to the website to view details of your order. </p>
                    </div> <!-- End -->
