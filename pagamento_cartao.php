                ...
                <div class="card-header">
                    ...
                    <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                        <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                            <li class="nav-item"> <a data-toggle="pill" href="pagamento_cartao.html" class="nav-link active "> <i class="fas fa-credit-card mr-2"></i> Cartao de credito </a> </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="cartao_credito" class="tab-pane fade show active pt-3">
                            <form role="form">
                                ...
                                <div class="card-footer"> <button type="button" class="subscribe btn btn-primary btn-block shadow-sm"> Prosseguir com a compra </button>
                            </form>
                        </div>
                    </div> 
