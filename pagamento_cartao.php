                ...
                <div class="card-header">
                    ...
                    <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                        <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                            <li class="nav-item"> <a data-toggle="pill" href="pagamento_cartao.php" class="nav-link active "> <i class="fas fa-credit-card mr-2"></i> Cartão </a> </li>
                            <li class="nav-item"> <a data-toggle="pill" href="pagamento_boleto.php" class="nav-link "> <i class="fab fa-paypal mr-2"></i> Boleto Bancário </a> </li>
                        </ul>
                    </div>
