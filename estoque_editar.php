  ...
  <div class="conteiner">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6" style="margin-top: 60px;">  <h2>Editar produto</h2> </div>  
        </div>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <form action="backend/atualizar_produto.php" method="post">
                ...
                <div class="row">
                    <?php
                        ...
                        echo '<input type="text" name="cod_produto" value="'.$row['cod_produto'].'" class="form-control d-none">';
                        echo '<div class="form-group"> 
                                <label for="nomeProduto"> </label> <input value="'.$row['nome_produto'].'" type="text" name="nomeProduto" placeholder="Nome do produto" required class="form-control">
                            </div>
                            ...
                            while($row1 = mysqli_fetch_array($result1)) {
                                echo '<option value="'.$row1['cod_categoria'].' "';
                                if($row['cod_catProduto'] == $row1['cod_categoria']) {
                                    echo 'selected';
                                    
                                }
                                echo '>'.$row1['nome_categoria'].'</option>';
                            }
                            echo '</select>';
                            echo'       </div>
                                        <div class="form-text" style="margin-top: 25px;">
                                            <textarea class="form-control" placeholder="Descrição" id="TextareaDescricaoProduto" name="TextareaDescricaoProduto" rows="3">'.$row['descricao_produto'].'</textarea>
                                        </div>
                                        <div class="form-group"> 
                                            <label for="linkImagem"> </label> <input type="text" value="'.$row['imagem'].'" name="LinkImagem" placeholder="Link da imagem" required class="form-control ">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group"> 
                                                <label for="qntProduto"> </label> <input type="text" value="'.$row['qnt_produto'].'" name="qntProduto" placeholder="Quantidade" required class="form-control ">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group"> 
                                                <label for="precoProduto"> </label> <input type="text" value="'.$row['preco_produto'].'" name="precoProduto" placeholder="Preço unidade" required class="form-control ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 25px;">
                                        <div class="col">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="promocao" value="0" id="flexRadioDefault2"';
                                                if($row['tem_promocao'] != "1") {
                                                    echo ' checked ';
                                                }
                                                echo '>
                                        ...
                                        <div class="col">
                                            <div class="form-group"> 
                                                <label for="porcentagPromo" > </label> <input type="text" name="porcentagPromo" placeholder="Porcentagem de desconto" required value="'.$row['porc_promocao'].'" class="form-control ">
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div class="row" style="margin-top: 40px;">
                                        <button type="submit" name="submit" class="btn btn-outline-secondary">Atualizar produto</button>
                                    </div>
                                </form>';
                        ?>
            </div>
