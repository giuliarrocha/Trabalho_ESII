          ...
          <div class="d-flex justify-content-end">
            <?php
                ...
                if($row = mysqli_fetch_array($result)) {
                    if($row['endereco'] == '') {
                        echo '<a class="btn btn-outline-secondary btn-lg" href="informacoes_cliente.php">Preencher endereço para comprar</a>';
                    } else if($row7){
                        echo '<a class="btn btn-outline-secondary btn-lg" href="pagamento_cartao.php">Continuar compra</a>';
                    }
                }
                ?>
          </div>
