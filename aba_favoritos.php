    ...
    <div class="row">
      <div class="col">
        ...
        <ul class="nav nav-tabs nav-fill" style="margin-top: 30px;">
          <li class="nav-item">
            <a class="nav-link active" href="aba_favoritos.php">Lista de favoritos</a>
          </li>
          <li class="nav-item">
        ...
        <?php
            ...
            $cpf = $_SESSION['cpf'];
            $query = "SELECT * FROM produto, lista_favorito, empresa WHERE cnpj = produto.cnpj_empresa AND cod_favProduto = cod_produto AND cpf_favCliente = '$cpf'";
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                <div class="row main align-items-center">
                    ...
                    if($row['tem_promocao'] == '1') {
                          echo number_format($row['preco_produto']*((100-$row['porc_promocao'])/100), 2);
                      }else{
                          echo number_format($row['preco_produto'], 2);
                      }
                          echo '
                        <a href="backend/remover_lista_fav.php?cod_produto='.$row['cod_favProduto'].'&retorna=aba_favoritos.php"><svg style="color:red; margin-left:5px; margin-bottom:5px" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
