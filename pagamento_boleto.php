                ...
                <div class="card-header">
                    ...
                    <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                        <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                            <li class="nav-item"> <a data-toggle="pill" href="pagamento_cartao.php" class="nav-link"> <i class="fas fa-credit-card mr-2"></i> Cartao de credito </a> </li>
                            <li class="nav-item"> <a data-toggle="pill" href="pagamento_boleto.php" class="nav-link active"> <i class="fab fa-paypal mr-2"></i> Boleto Bancário </a> </li>
                        </ul>
                    </div>
                    ...
                    <div id="boleto" class="tab-pane fade show active pt-3">
                        ...
                        <form action="backend/efetua_compra_boleto.php" method="post">
                        <div class="form-group "> 
                            <label class="radio-inline"> <input type="radio" name="boleto" value="imprimir" checked> Imprimir Boleto </label> 
                            <label class="radio-inline"> <input type="radio" name="boleto" value="mandar" class="ml-5">Mandar Boleto por email </label>
                        </div>
                        <p> <button type="submit" class="btn btn-primary " name="submit"><i class="fab fa-paypal mr-2"></i> Gerar boleto bancário</button>  </p>
                        </form>
